...
The package provides default current-frontend plugins. Pin or override their OCI
references in `tests/config/dynamic-plugins.yaml` like any other plugin; workspace
configuration wins over package defaults.
